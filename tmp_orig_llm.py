...
def set_llm_log_file(path: str):
    """隶ｾ鄂ｮ LLM 蜩榊ｺ疲律蠢玲枚莉ｶ霍ｯ蠕・りｮｾ鄂ｮ蜷・call_deepseek 莨壼ｰ・桃蠎泌・蜈･隸･譁・ｻｶ縲・""
    global _log_file
    _log_file = path


def _log_response(content: str):
    """蟆・LLM 蜩榊ｺ泌・蜈･譌･蠢玲枚莉ｶ・亥ｦょｷｲ驟咲ｽｮ・・""
    if not _log_file:
        return
...
縲占ｰ・衍蜻倥・  謠剰ｿｰ・嘴inv_desc or '・域裏・・}
  譛ｬ霓ｮ霎灘・・嘴player_input or '・域裏・・}

縲仙ｽ灘燕譽螳壹・  螳樔ｽ難ｼ嘴entity_name}
  謚閭ｽ・嘴skill_name}
  謚閭ｽ蛟ｼ・嘴skill_value}
  蜴溷ｧ矩ｪｰ蟄撰ｼ咼100={dice_roll}
  蝓ｺ遑遲臥ｺｧ・嘴base_tier}・・ailure < regular < hard < extreme・・  蜴溷ｧ狗ｻ捺棡謠剰ｿｰ・嘴skill_detail}
  譽螳壻ｸ贋ｸ区枚・嘴'謳懃ｴ｢萓ｦ譟･' if search_context else '螳樔ｽ謎ｺ､莠・}

縲仙・郤ｧ扈捺棡蜿り・・{graded_text or '・域裏蛻・ｺｧ扈捺棡・・}

COC 7th 隗・・・壽栫髫ｾ竕､謚閭ｽ蛟ｼ/5={max(1, skill_value // 5)}・悟峅髫ｾ竕､謚閭ｽ蛟ｼ/2={max(1, skill_value // 2)}・悟ｸｸ隗・王謚閭ｽ蛟ｼ={skill_value}・悟凄蛻吝､ｱ雍･縲ょ､ｧ謌仙粥=1・悟､ｧ螟ｱ雍･竕･96縲・
隸ｷ蛻､譁ｭ・壼渕莠手ｰ・衍蜻倡噪迚ｹ雍ｨ謠剰ｿｰ蜥梧悽霓ｮ螳樣刔陦御ｸｺ・梧弍蜷ｦ蠎比ｿｮ豁｣譽螳夂ｻ捺棡・・
菫ｮ豁｣騾ｻ霎托ｼ亥・驛ｨ諤晁・ｼ御ｸ崎ｾ灘・・会ｼ・- 諤晁・ｪｰ蟄仙ｺ比ｸ頑ｵｮ謌紋ｸ区ｵｮ螟壼ｰ醍せ・域怙螟堋ｱ20・会ｼ檎┯蜷取丐蟆・芦譛扈育ｭ臥ｺｧ
- 迚ｹ雍ｨ荳取橿閭ｽ蜥瑚｡御ｸｺ鬮伜ｺｦ蛹ｹ驟堺ｸ疲怏莨伜漢 竊・鬪ｰ蟄蝉ｸ区ｵｮ・域峩螳ｹ譏捺・蜉滂ｼ・- 迚ｹ雍ｨ荳手｡御ｸｺ蜀ｲ遯∵・蜉｣蜉ｿ 竊・鬪ｰ蟄蝉ｸ頑ｵｮ・域峩髫ｾ謌仙粥・・- 迚ｹ雍ｨ譌蜈ｳ 竊・荳堺ｿｮ豁｣
- 譛画・遑ｮ迚ｹ谿願ｧ・・隸ｴ譏守噪謖臥音谿願ｧ・・扈鍋ｮ・- 譬ｹ謐ｮ邇ｩ螳ｶ逧・悽霓ｮ霎灘・鬚晏､冶・㍼縲よ紛菴灘次蛻呻ｼ夊｡悟勘雜願ｮ､逵溯ｶ雁ｮｹ譏捺・蜉溷渚荵句酔逅・- 譬ｹ謐ｮ譛ｬ霓ｮ霎灘・逧・ｿｮ豁｣荳崎ｶ・ｿ・0轤ｹ(ﾂｱ10)

遉ｺ萓具ｼ・- "隗ょｯ溷鴨譫∝・莨倡ｧ" 逧・自螳ｶ蝨ｨ譏乗囓邇ｯ蠅・ｾｦ譟･ 竊・鬪ｰ蟄仙庄荳区ｵｮ5-10轤ｹ・悟庄閭ｽ莉・regular 蜊・・ hard
- "閭・ｰ丞ｦるｼ" 逧・自螳ｶ隸募崟諱仙嵩諤ｪ迚ｩ 竊・鬪ｰ蟄仙庄荳頑ｵｮ10-15轤ｹ・悟庄閭ｽ莉・hard 髯崎・ regular 逕夊・ failure
- "邊ｾ騾壽惻譴ｰ" 逧・ｷ･遞句ｸ井ｿｮ逅・ｼ墓梼・御ｽ・ｪｰ蟄・2蛻壼･ｽ雜・・謚閭ｽ60 竊・鬪ｰ蟄蝉ｸ区ｵｮ5轤ｹ蜊ｳ蜿ｯ莉・failure 謨大屓 regular
- 莉皮ｻ・頗邏｢蝨ｺ譎ｯ・檎ｭ帛ｭ仙庄荳玖ｰ・轤ｹ
霑泌屓 JSON・・{{
  "tier": "{base_tier}",
  "detail_override": null,
  "reason": "菫ｮ豁｣謌紋ｸ堺ｿｮ豁｣逧・炊逕ｱ・亥桁蜷ｫ陌壽供鬪ｰ蟄占ｰ・紛驥擾ｼ・
}}

鬚晏､冶ｧ・・・・- tier 譏ｯ菫ｮ豁｣蜷守噪遲臥ｺｧ・悟宵閭ｽ譏ｯ failure / regular / hard / extreme 荵倶ｸ
- 闍･譌髴菫ｮ豁｣・郁劒諡滄ｪｰ蟄占ｰ・紛驥丈ｸｺ0・会ｼ荊ier 蠢・｡ｻ荳･譬ｼ遲我ｺ主渕遑遲臥ｺｧ "{base_tier}"・御ｸ榊ｾ玲隼蜿・- 荳崎ｮｺ菫ｮ豁｣蜷守噪扈捺棡螯ゆｽ包ｼ悟宵隕∝次蟋狗ｻ捺棡荳肴弍螟ｧ謌仙粥/螟ｧ螟ｱ雍･ 譁ｰ逧・ｻ捺棡荵滉ｸ崎・譏ｯ螟ｧ謌仙粥/螟ｧ螟ｱ雍･・碁勁髱樒自螳ｶ譛画・遑ｮ逧・音谿願ｧ・・縲・- reason 荳ｭ蠎疲署蜿雁・驛ｨ蛻､譁ｭ逧・劒諡滄ｪｰ蟄占ｰ・紛驥・- detail_override 莉・惠遑ｮ螳樣怙隕∵眠逧・ｻ捺棡謠剰ｿｰ譌ｶ蝪ｫ蜀・- 逶ｴ謗･霎灘・ JSON
"""
    response = client.chat.completions.create(
