...
| `_split_requirement` | `(req) -> (hard, soft)` | `\|\|` 拆分硬/软条件 | 482 |
| `_is_simple_requirement` / `_check_simple_requirement` | — | AT 简单条件判定 | 493 / 504 |
| `_evaluate_requirement` | `(req) -> (bool, msg)` | flag: → AND/OR 解析 → 边依赖检查 | 515 |
