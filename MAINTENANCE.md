...
| 函数 | 签名 | 作用 | 行号 |
|------|------|------|------|
| `_serialize_enemies_for_frontend` / `_serialize_combat_state_for_frontend` | — | 敌人/CombatState 前端子集 | 12 / 35 |
