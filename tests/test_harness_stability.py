...
CASE_A = {
    ...
    "turns": [
        ("搜索车厢并拾取手电筒",
         "search: 6号厢, 发现手电筒+撬棍 → 自动拾取手电筒"),
        ("检查座椅下方看看有没有什么东西",
         "I19: 无检定, 获取火柴 @item_gain"),
        ("检查车厢内的应急柜",
         "I18: 侦查检定, 获取急救包 @item_gain"),
        ("前往5号车厢",
         "move: 6号车厢 → 5号车厢"),
        ("搜索5号车厢并拾取小刀",
         "search: 5号厢, 发现小刀 → 自动拾取, I4寻找报纸"),
        ("翻找这节车厢的垃圾桶",
...
CASE_B = {
    "name": "B_npc_follow_interact",
    "turns": [
        ("前往5号车厢",
         "move: 6号车厢 → 5号车厢"),
        ("前往4号车厢",
         "move: 5号车厢 → 4号车厢, NPC京山人吉在场景内"),
        ("抢救乘务员 #必成",
         "I7: 急救检定, ##GRADED## 强制成功"),
        ("请求乘务员跟随你，然后前往3号车厢",
         "NPC follow + move: 4号车厢 → 3号车厢, NPC跟随移动"),
        ("在3号车厢搜寻乘务员掉落的黑色背包",
         "I8: 侦察检定, NPC bound entity @3号车厢"),
    ],
}
